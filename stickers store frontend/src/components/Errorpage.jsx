...
import errorImage from "../../util/error.png";
      ...
      <main className="flex-grow">
        <div className="py-12 bg-normalbg dark:bg-darkbg font-primary">
          ...
          <div className="text-center text-gray-600 dark:text-lighter flex flex-col items-center">
            ...
            <Link
              to="/home"
              className="py-3 px-6 text-primary dark:text-dark text-xl rounded-md transition duration-200 bg-darkbg dark:bg-normalbg hover:bg-dark dark:hover:bg-lighter font-semibold"
            >
              Back to Home
            </Link>
          </div>
