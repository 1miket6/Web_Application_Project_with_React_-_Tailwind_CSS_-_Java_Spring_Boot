...
export default function ProductCard({ product }) {
  return (
    <Link to={`/products/${product.productId}`} state={{product}} className="w-72 rounded-md mx-auto border border-dark dark:border-primary shadow-md overflow-hidden flex flex-col hover:border-primary dark:hover:border-dark transition">
